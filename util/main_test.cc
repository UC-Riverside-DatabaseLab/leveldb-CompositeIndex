...
static string database = basefilepath + "DB/Composite_Static_UserID";
...
static string result_file = basefilepath + "Results/Composite_Static_UserID.csv";
static string iostat_file = basefilepath + "Results/Composite_Static_UserID_iostat.csv";
...
int main(int argc, char** argv) {
	...
	else
	{
		...
		//PerformStaticWorkload(false, false, 5);
